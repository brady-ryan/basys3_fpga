...
# Switches
set_property PACKAGE_PIN V17 [get_ports override]
...
set_property PACKAGE_PIN V16 [get_ports shutoff]
set_property IOSTANDARD LVCMOS33 [get_ports shutoff]

set_property PACKAGE_PIN L17 [get_ports trigger]
